    ...
    return (
        <div class="hero min-h-screen bg-base-200">
            <div class="hero-content flex-col lg:flex-row-reverse">
                <img src="https://images.unsplash.com/photo-1606676539940-12768ce0e762?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8ZWxlY3Ryb25pcyUyMHRvb2x8ZW58MHwxfDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" class="max-w-sm rounded-lg shadow-2xl" alt='' />
                <div>
